...
// IF THE SESSION[role] = admin, retrieve all the portfolio
if ($_SESSION['role'] == 'admin') {

    if (isset($_POST['submit-search'])) {
        $keywords = mysqli_real_escape_string($conn, $_POST['search']);
        $execute_query = "SELECT portfolio.*, users.username, users.email
        FROM portfolio 
        INNER JOIN users ON portfolio.userID = users.userID 
        WHERE title LIKE '%$keywords%'";
    } else {
        $execute_query = "SELECT * FROM portfolio";
    }
    ...
    // IF THE SESSION[role] = user, retrieve the portfolio based on the session id
    $userID = $_SESSION['id'];
